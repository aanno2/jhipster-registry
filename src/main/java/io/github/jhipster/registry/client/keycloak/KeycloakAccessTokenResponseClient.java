...
public class KeycloakAccessTokenResponseClient implements OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> {
    ...
    protected final TokenSessionStore tokenSessionStore;

    protected final OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> wrapped;

    public KeycloakAccessTokenResponseClient(Environment env, TokenSessionStore tokenSessionStore) {
        this(env, new DefaultAuthorizationCodeTokenResponseClient(), tokenSessionStore);
    }

    public KeycloakAccessTokenResponseClient(
        Environment env, OAuth2AccessTokenResponseClient<OAuth2AuthorizationCodeGrantRequest> wrapped,
    ...
    public OAuth2AccessTokenResponse getTokenResponse(OAuth2AuthorizationCodeGrantRequest authorizationGrantRequest) {
        ...
        tokenSessionStore.setOAuth2AccessTokenResponse(result);
